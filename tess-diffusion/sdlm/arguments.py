...
class DiffusionArguments:
    ...
    top_k: Optional[int] = field(default=None, metadata={"help": "top_k value for top_k sampling."})
    ...
    distillation_loss_type: str = field(default="mse")

@dataclass
class DecodingArguments:
    classifier_control: str = field(default="length")
    classifier_model_name_or_path: str = field(default=None)
    control_lambda: float = field(default=100.0)
    lambda_schedule: str = field(default="constant")
    lambda_alpha: float = field(default=1.0)
    lambda_beta: float = field(default=0.0)
    control_iteration: int = field(default=3)
    decoding_strategy: str = field(default="MBR")
    num_generate_samples: int = field(default=1)
    beam_size: int = field(default=None)
    eval_per_n_step: int = field(default=200)
    perplexity_model_name_or_path: str = field(default="gpt2-large")
    token_schedule: str = field(default="constant")
    token_alpha: float = field(default = 1.0)
    token_beta: float = field(default = 0.0)
    pos_classifier: str = field(default = None)
    tree_classifier: str = field(default = None)
    sentiment_classifier: str = field(default = None)
    topic_classifier: str = field(default = None)
    toxicity_classifier: str = field(default = None)
    sub_classifier: str = field(default = None)
    sub_classifiers: List[str] = field(default = None)
    qqp_classifier: str = field(default = None)
    checkpoint_dir: str=field(default=None)
    checkpoint_file: str=field(default=None)
    scale_initial_noise: float = field(default=1.0)
    scale_intermediate_noise: float = field(default=1.0)
    classifier_begin_step: int = field(default=1000)
    classifier_end_step: int = field(default=0)
    classifier_interval: int = field(default=1)
    initial_noise_type: str = field(default = "randn")
    intermediate_noise_type: str = field(default = "randn")
    ddim: bool = field(default= False)
    schedule_warm_up_step: int = field(default = 0)
    fluency_classifier_name_or_path: str = field(default = None)
    fluency_classifier_begin_step: int = field(default=1000)
    fluency_classifier_end_step: int = field(default=0)
    fluency_classifier_interval: int = field(default=1)
    fluency_classifier_lambda: float = field(default=1.0)
    fluency_classifier_iteration: int = field(default=0)
    monotonic: bool = field(default=False)
    ignore_prompts: bool = field(default=False)
